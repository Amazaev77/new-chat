В приложении три основных компонента:
...
Правый компонент InfoBar показывает информацию этого контакта. [ДЕМО](https://stormy-hollows-82319.herokuapp.com/5f444961a00c98053c489d5a)
